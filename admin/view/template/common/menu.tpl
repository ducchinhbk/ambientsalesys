<ul id="menu">
    <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span>Ambient System</span></a>
    <ul>
      <li><a href="<?php echo $dashboard; ?>">Dashboard</a></li>
      <li><a href="<?php echo $booking; ?>">Booking</a></li>
      <li><a class="parent">Members</a>
        <ul>
          <li><a href="<?php echo $amsuser; ?>">Members</a></li>
          <li><a href="<?php echo $amsuser_group; ?>">Members group</a></li>
        </ul>
      </li>
    </ul>
  </li>
