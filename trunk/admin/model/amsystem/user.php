...
class ModelAmsystemUser extends Model {
    ...
    public function getTarget($user_id){
        $query = $this->db->query("SELECT target FROM `user` WHERE user_id =  '" . (int)$user_id . "'");
    ...
    public function getUsergroupByUserID($user_id) {
		$query = $this->db->query("SELECT user_group_id FROM `" . DB_PREFIX . "user` WHERE user_id = '" . $this->db->escape($user_id) . "' ");
