      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="target" value="<?php echo $target; ?>" placeholder="Nhập số.." id="input-target" class="form-control" />
              <?php if ($error_target) { ?>
              <div class="text-danger"><?php echo $error_target; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="telephone" value="<?php echo $telephone; ?>" placeholder="telephone.." id="input-telephone" class="form-control" />
            </div>
          </div>
          <div class="form-group">
