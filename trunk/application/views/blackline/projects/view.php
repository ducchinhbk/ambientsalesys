...
<div id="overview">
	...
	<div class="span6">
		...
		<div class="table_head"><h6><i class="icon-align-left"></i> <?=$this->lang->line('application_notes');?></h6> <input type="submit" id="send" name="send" class="btn btn-mini pull-right" value="<?=$this->lang->line('application_save');?>"/><span id="changed" class="pull-right label label-warning"><?=$this->lang->line('application_unsaved');?></span></div>
