	<div id="main">	
		...
		<div class='alert alert-error'>No write permissions to the following folders <b>/application/</b> and <b>/assets/</b> <br> Please change the permissions of those folders temporary to 777 in order to install the updates. Change the permissions back to 755 after you have installed all updates.</div>
		<?php } ?>
		...
		<tr>
			...
			<td class="option btn-group">
				...
				<a <?php if(in_array($file->file, $downloaded_updates) && $writable == "TRUE"){echo 'href="update_install/'.$file->file.'/'.$file->version.'" class="btn btn-mini"';}else{ echo 'class="btn btn-mini disabled"';} ?>><?=$this->lang->line('application_install');?></a>
				<?php } ?>
			</td>
		</tr>
