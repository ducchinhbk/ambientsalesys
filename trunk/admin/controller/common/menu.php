...
class ControllerCommonMenu extends Controller {
	public function index() {
        ...
        /**Ambient System**/
        $data['dashboard'] = $this->url->link('amsystem/dashboard', 'token=' . $this->session->data['token'], 'SSL');
		$data['booking'] = $this->url->link('amsystem/booking', 'token=' . $this->session->data['token'], 'SSL');
        $data['amsuser'] = $this->url->link('amsystem/user', 'token=' . $this->session->data['token'], 'SSL');
		$data['amsuser_group'] = $this->url->link('amsystem/user_permission', 'token=' . $this->session->data['token'], 'SSL');
        /*************/
