...
<table id="settings" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td><?=$this->lang->line('application_logo');?> (max 200x200)<a class="cursor po pull-right" rel="popover" data-content="<div class='logo'><img src='<?=$core_settings->logo;?>'></div>" data-original-title="<?=$this->lang->line('application_logo');?>"><i class="fam-information"></i></a>
		</td>
		<td>
	...
	<tr>
		<td><?=$this->lang->line('application_invoice');?> <?=$this->lang->line('application_logo');?>  (max 200x200)<a class="cursor po pull-right" rel="popover" data-content="<div class='logo' style='background:#FFFFFF'><img src='<?=$core_settings->invoice_logo;?>'></div>" data-original-title="<?=$this->lang->line('application_invoice');?> <?=$this->lang->line('application_logo');?>"><i class="fam-information"></i></a>
		</td>
		<td>
